<template>
    <div class="cascad-menu" ref="cascadMenu">
        <div class="left-menu">
            <scroll :data="menus" ref="leftMenu">
        ...
        <div class="right-menu">
            <scroll :data="menus" ref="rightMenu" @scroll="scrollHeight" :listenScroll="true" :probeType="3">
                <div class="right-menu-container">
                    <ul>
                        <li class="right-item" ref="rightItem" v-for="(menu, i) in data" :key="i">
